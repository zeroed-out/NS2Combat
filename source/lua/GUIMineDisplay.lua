...
function GUIMineDisplay:Initialize()
    ...
    self.ammoTextBg:SetScale(Vector(1.2, 1.2, 1.2))
    ...
    self.ammoText:SetScale(Vector(1.2, 1.2, 1.2))
...
function GUIMineDisplay:SetMax(maxClip)
    self.weaponMax = maxClip
end
...
function GUIMineDisplay:Update(deltaTime)
    ...
    local ammoFormat = string.format("%s/%s", self.weaponClip, self.weaponMax)
