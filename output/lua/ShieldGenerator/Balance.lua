...
kShieldGeneratorTechResearchTime = 45
...
kPersonalShield2RepairDelay = 2.0

kShieldGenerator3ResearchCost = 20
kShieldGenerator3TechResearchTime = 45
kPersonalShield3ArmorBonus = 20.0
kPersonalShield3RepairDelay = 2.0

kPersonalShieldWeight = 0.1 -- more than a grenade
